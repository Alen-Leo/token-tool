...
(function () {
  ...
  const DICT = {
    en: {
      ...
      'settings.ph.accountLabel': 'optional, e.g. work',
      'settings.addAccount': '＋ Add account',
      'settings.removeAccount': 'Remove this account',
      'settings.removeConfirm': 'Remove this account (its key and settings)?',
      'settings.newAccount': 'New account',
      'settings.envAccount': 'This account comes from an environment variable — effective this session only.',
      'settings.test': 'Test',
      'settings.save': 'Save',
      'settings.testEnterKey': 'enter a key to test',
      'settings.testing': 'testing…',
      'settings.nothingToSave': 'nothing to save',
      'settings.enterKeyToSave': 'enter an API key or web token first',
    ...
    zh: {
      ...
      'settings.label.label': '备注',
      'settings.ph.accountLabel': '可选，如：工作账号',
      'settings.addAccount': '＋ 添加账号',
      'settings.removeAccount': '移除该账号',
      'settings.removeConfirm': '确定移除该账号（密钥与配置）？',
      'settings.newAccount': '新账号',
      'settings.envAccount': '该账号来自环境变量，仅本次会话有效。',
      'settings.test': '测试',
      'settings.save': '保存',
      'settings.testEnterKey': '请输入密钥后再测试',
      'settings.testing': '测试中…',
      'settings.nothingToSave': '没有可保存的内容',
      'settings.enterKeyToSave': '请先输入 API Key 或网页 Token',
